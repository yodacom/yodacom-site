...
<section class="mx-auto max-w-6xl space-y-14 px-6 py-20">
	<!-- CoinRoc hero card with 2019 screenshot -->
	<article class="overflow-hidden rounded-sm border border-rule bg-paper shadow-[0_20px_60px_-30px_rgba(20,40,72,0.3)]">
	...
	<div class="grid gap-6 md:grid-cols-2">
		...
		<article class="rounded-sm border border-rule bg-paper p-8">
			...
			<a
				...
				class="inline-flex items-center rounded-sm border border-navy-deep/30 px-5 py-3 text-xs font-semibold uppercase tracking-wider text-navy-deep transition hover:border-navy-deep hover:bg-cream-deep/40"
			>
				Inquire →
			</a>
		</article>
